#############################################################################
# Makefile for building: soccer
# Generated by qmake (3.0) (Qt 5.4.0)
# Project:  ../soccer/soccer.pro
# Template: app
# Command: /home/durson/Qt/5.4/gcc_64/bin/qmake -spec linux-g++ -o Makefile ../soccer/soccer.pro
#############################################################################
...
INCPATH       = -I../../../Qt/5.4/gcc_64/mkspecs/linux-g++ -I../soccer -I../../../Qt/5.4/gcc_64/include -I../../../Qt/5.4/gcc_64/include/QtCore -I. -I.
QMAKE         = /home/durson/Qt/5.4/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = soccer1.0.0
DISTDIR = /home/durson/documents/Qt/soccer/.tmp/soccer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/durson/Qt/5.4/gcc_64 -Wl,-rpath,/home/durson/Qt/5.4/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/durson/Qt/5.4/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../../Qt/5.4/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../soccer/soccer.pro  ../soccer/main.cpp
QMAKE_TARGET  = soccer
...
Makefile: ../soccer/soccer.pro ../../../Qt/5.4/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.4/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.4/gcc_64/mkspecs/common/shell-unix.conf \
		../../../Qt/5.4/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.4/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.4/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.4/gcc_64/mkspecs/features/lex.prf \
		../soccer/soccer.pro \
		/home/durson/Qt/5.4/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ -o Makefile ../soccer/soccer.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../soccer/main.cpp $(DISTDIR)/
...
main.o: ../soccer/main.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../soccer/main.cpp
